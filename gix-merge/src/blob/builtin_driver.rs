...
///
pub mod text {
    /// The way the built-in [text driver](imara_diff::blob::BuiltinDriver::Text) will express
    ...
    /// Options for the builtin [text driver](imara_diff::blob::BuiltinDriver::Text).
